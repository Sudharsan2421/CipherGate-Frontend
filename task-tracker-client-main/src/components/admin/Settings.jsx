    ...
    const fetchSettings = async () => {
        ...
        try {
            ...
            setSettings((prevSettings) => ({
                ...
                // Work location settings
                workLocation: fetchedSettings.workLocation || {
                    enabled: true,
                    latitude: 0,
                    longitude: 0,
                    radius: 100
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                {/* Work Location Settings */}
                <Card className="mb-8 hover:shadow-lg transition-shadow duration-200">
                    <div className="h-2 bg-gradient-to-r from-cyan-400 to-blue-400" />
                    <div className="p-6">
                        <h3 className="text-lg font-semibold mb-6 flex items-center text-gray-900">
                            <div className="p-2 bg-cyan-100 rounded-lg mr-3">
                                <FiMapPin className="h-5 w-5 text-cyan-600" />
                            </div>
                            Work Location Settings
                        </h3>
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    <label className="text-sm font-medium text-gray-700">Enable Location Verification</label>
                                    <p className="text-xs text-gray-500">Require workers to be at work location for attendance</p>
                                </div>
                                <CustomToggle
                                    checked={settings.workLocation?.enabled}
                                    onChange={() => {
                                        const updatedSettings = {
                                            ...settings,
                                            workLocation: {
                                                ...settings.workLocation,
                                                enabled: !settings.workLocation?.enabled
                                            }
                                        };
                                        setSettings(updatedSettings);
                                        checkForChanges(updatedSettings);
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        type="number"
                                        step="any"
                                        value={settings.workLocation?.latitude || 0}
                                        onChange={(e) => {
                                            const updatedSettings = {
                                                ...settings,
                                                workLocation: {
                                        ...
                                        className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                    />
                                    <p className="text-xs text-gray-500">Work location latitude coordinate</p>
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input
                                        type="number"
                                        step="any"
                                        value={settings.workLocation?.longitude || 0}
                                        onChange={(e) => {
                                            const updatedSettings = {
                                                ...settings,
                                                workLocation: {
                                        ...
                                        className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                    />
                                    <p className="text-xs text-gray-500">Work location longitude coordinate</p>
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        min="10"
                                        max="1000"
                                        value={settings.workLocation?.radius || 100}
                                        onChange={(e) => {
                                            const updatedSettings = {
                                                ...settings,
                                                workLocation: {
                                        ...
                                        className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                    />
                                    <p className="text-xs text-gray-500">Allowed distance from work location (in meters)</p>
                                </div>
                            </div>
                            
                            <div className="bg-blue-50 p-4 rounded-lg">
                                <h4 className="text-sm font-medium text-blue-700 mb-2">💡 How to set your work location</h4>
                                <ol className="text-xs text-blue-600 list-decimal pl-4 space-y-1">
                                    <li>Visit your workplace</li>
                                    <li>Open Google Maps on your phone</li>
                                    <li>Tap and hold on your location</li>
                                    <li>The coordinates will appear at the bottom</li>
                                    <li>Enter those values above</li>
                                </ol>
                                <button 
                                    type="button"
                                    className="mt-3 text-xs text-white bg-blue-500 hover:bg-blue-600 px-3 py-1 rounded"
                                    onClick={() => {
                                        if (navigator.geolocation) {
                                            navigator.geolocation.getCurrentPosition(
                                                (position) => {
                                                    ...
                                                    setSettings(updatedSettings);
                                                    checkForChanges(updatedSettings);
                                                    toast.success('Current location set as work location');
                                                },
