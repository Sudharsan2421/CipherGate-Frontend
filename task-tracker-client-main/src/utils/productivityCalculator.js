export const calculateWorkerProductivity = (productivityParameters) => {
    ...
    // --- NEW: Timezone-safe date formatter ---
    ...
    // Calculate the number of actual working days by excluding Sundays
...
export const calculateSingleProductivity = (options) => {
  // ... implementation for single productivity calculation
  return {};
};